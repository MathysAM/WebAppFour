...
/**
 * 1) Connexion + enregistrement des handlers
 */
window.connectMqtt = (brokerUrl, user, pass, dotNetHelper) => {
    ...
    window.mqttClient.on('error', err => {
        ...
        // Remonte le détail technique si besoin
...
/**
 * 6) Boucle de ping QoS 1 : mise à jour de mqttPingOk
 */
